...
def Diffusion(r,move,x,y):# where r is a random number, x and y are the coordinations of the particle decided by the random number,

    # move means the moving direction of the particle
...
for i in range(time): 
    ...
    xm, ym = (mol[m][0], mol[m][1]) # coordinates of the molecule
